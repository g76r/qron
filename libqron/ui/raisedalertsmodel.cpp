...
RaisedAlertsModel::RaisedAlertsModel(QObject *parent)
  ...
  setHeaderDataFromTemplate(Alert("template"));
  setDefaultInsertionPoint(SharedUiItemsTableModel::FirstItem);
}

//void RaisedAlertsModel::changeItem(SharedUiItem newItem, SharedUiItem oldItem) {
//  SharedUiItemsTableModel::changeItem(newItem, oldItem);
//  //qDebug() << "RaisedAlertsModel::changeItem" << newItem.id() << oldItem.id()
//  //         << rowCount();
//}
